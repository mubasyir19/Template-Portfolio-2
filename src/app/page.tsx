  ...
  return (
    <div className=''>
      <section className='h-screen flex items-center justify-center'>
        <div className=''>
          <div className='mx-auto bg-linear-to-br from-[#FF8660] to-[#9A33FF] rounded-full size-52 overflow-hidden'>
            <Image src={`/images/avatar2.png`} width={213} height={213} alt='avatar' className='size-60 object-cover' />
          </div>
          <h1 className='mt-10 text-white text-center font-extrabold text-6xl'>
            I do code and <br /> make content{' '}
            <span className='bg-linear-to-br from-[#FF8660]  to-[#9A33FF] bg-clip-text text-transparent'>
              about it!
            </span>
          </h1>
          <p className='mt-10 text-[#C5C5C5] text-center w-1/2 mx-auto'>
      ...
      <section className='py-12'>
        ...
        <div className='mt-7 grid grid-cols-1 lg:grid-cols-2 w-3/5 mx-auto gap-7 justify-items-center'>
      ...
      <section className='py-12'>
        ...
        <div className='mt-14 w-3/5 mx-auto space-y-12'>
      ...
      <section className='py-12'>
        ...
        <div id='list-experience' className='mt-14 w-3/5 mx-auto space-y-12'>
          <div id='experience' className=''>
            <div className='flex items-center justify-between'>
      ...
      <footer className='py-24 bg-[#191919]'>
        <div className='w-3/5 mx-auto'>
          <h3 className='text-white font-bold text-2xl'>Contact</h3>
          <p className='mt-9 w-3/4 text-light-grey text-sm'>
